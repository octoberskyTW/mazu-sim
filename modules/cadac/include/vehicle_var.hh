...
public:
    STAGE_VAR();
    ~STAGE_VAR(){};
    STAGE_VAR(const STAGE_VAR &other) = delete;
    STAGE_VAR operator=(const STAGE_VAR &other) = delete;
...
public:
    Aerodynamics_var();
    ~Aerodynamics_var(){};
    Aerodynamics_var(const Aerodynamics_var &other) = delete;
    Aerodynamics_var operator=(const Aerodynamics_var &other) = delete;
...
public:
    ...
    ~EarthEnvironment_var(){};
    EarthEnvironment_var(const EarthEnvironment_var &other) = delete;
    EarthEnvironment_var operator=(const EarthEnvironment_var &other) = delete;
    ...
    VECTOR(WEIE, 3); /* ** (--)  Earth rate in ECEF coordinate */
...
public:
    DM_var();
    ~DM_var(){};
    DM_var(const DM_var &other) = delete;
    DM_var operator=(const DM_var &other) = delete;
...
public:
    Prop_var();
    ~Prop_var(){};
    Prop_var(const Prop_var &other) = delete;
    Prop_var operator=(const Prop_var &other) = delete;
...
public:
    ACT_var();
    ~ACT_var(){};
    ACT_var(const ACT_var &other) = delete;
    ACT_var operator=(const ACT_var &other) = delete;
...
public:
    Sensor_var();
    ~Sensor_var(){};
    Sensor_var(const Sensor_var &other) = delete;
    Sensor_var operator=(const Sensor_var &other) = delete;
